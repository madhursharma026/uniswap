        ...
        <div className="container-xl pb-5" style={{ paddingTop: '52px' }}>
          ...
          <div className="row mt-5">
            <div className="col-lg-4 mt-lg-0 mt-3">
              <div class="card p-3 h-100" style={{ background: '#F5F6FC', border: 'none', boxShadow: "rgba(100, 100, 111, 0.2) 0px 7px 29px 0px" }}>
                <div class="card-body">
                  <h2 class="card-title">Buy Crypto <span style={{ float: 'right' }}><i class="fa fa-dollar"></i></span></h2>
                  <h4 class="card-subtitle mb-2 mt-4 text-secondary">Buy crypto with your credit card or bank account at the best rates.</h4>
            ...
            <div className="col-lg-4 mt-lg-0 mt-3">
              <div class="card p-3 h-100" style={{ background: '#F5F6FC', border: 'none', boxShadow: "rgba(100, 100, 111, 0.2) 0px 7px 29px 0px" }}>
                <div class="card-body">
                  <h2 class="card-title">Earn <span style={{ float: 'right' }}><i class="fa fa-line-chart"></i></span></h2>
                  <h4 class="card-subtitle mb-2 mt-4 text-secondary">Provide liquidity to pools on Uniswap and earn fees on swaps.</h4>
            ...
            <div className="col-lg-4 mt-lg-0 mt-3">
              <div class="card p-3 h-100" style={{ background: '#F5F6FC', border: 'none', boxShadow: "rgba(100, 100, 111, 0.2) 0px 7px 29px 0px" }}>
                <div class="card-body">
                  <h2 class="card-title">Build dApps <span style={{ float: 'right' }}><i class="fa fa-angle-double-right"></i></span></h2>
                  <h4 class="card-subtitle mb-2 mt-4 text-secondary">Build apps and tools on the largest DeFi protocol on Ethereum.</h4>
